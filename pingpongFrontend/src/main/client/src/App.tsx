...
const LandingPage = () => (
  <div style={{ 
    ...
    <img 
      src="/src/assets/pingpong-logo.png" 
      alt="PingPong Logo" 
      className="animated-logo"
      style={{ width: '200px', marginBottom: '2rem' }} 
    />
    <h1 style={{ fontSize: '3rem', marginBottom: '1rem', color: '#1976d2' }}>Welcome to PingPong</h1>
    ...
    <div style={{ position: 'absolute', bottom: 24, width: '100%', textAlign: 'center' }}>
      <p style={{ color: '#1976d2', fontWeight: 500, fontSize: '1.1rem', margin: 0 }}>Made with ❤️ by @gantavyamalviya</p>
    </div>
  </div>
);
